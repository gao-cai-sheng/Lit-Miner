...
if not available_queries:
    st.warning("⚠️ No stored queries found. Please run a [Search](Search) first!")
    st.stop()
...
with st.form("write_form"):
    ...
    submitted = st.form_submit_button("✍️ Generate Review", type="primary")

# Handle generation
if submitted:
    if not query:
        st.warning("⚠️ Please select a query")
    else:
        # Log container
        ...
        try:
            st.info("✍️ Generating AI-powered review...")
            ...
            # Success message
            st.success(f"✅ Review generated successfully!")
...
if "generated_review" in st.session_state:
    ...
    st.info("👆 Configure settings above and click 'Generate Review' to get started")
